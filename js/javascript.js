...
renderer.setSize(window.innerWidth, window.innerHeight);
 ...
 gltfLoader.load(url + '../WebsitePortfolio/assets/comets/meteorite/scene.gltf', (comet) => {
 ...
 gltfLoader.load(url + '../WebsitePortfolio/assets/comets/rock2/scene.gltf', (comet) => {
 ...
 gltfLoader.load(url + '../WebsitePortfolio/assets/comets/meteorite2/scene.gltf', (comet) => {
